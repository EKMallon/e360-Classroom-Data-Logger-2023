...
![Image](https://github.com/user-attachments/assets/90d93949-34fe-46d0-b0b0-d4a1093a353c)
...
In 2026: New configuration options were added to the start-up menu [ accessed via the IDEs Serial Monitor window ] 
